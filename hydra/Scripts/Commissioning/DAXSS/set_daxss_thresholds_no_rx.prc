;Commission DAXSS THFA and THSL No Rx
;Purpose: Loop to change X123 slow & fast thresholds
;         in safe mode and playback last 3 minutes with changes
...
;	 Playback last 5 minutes of data
;
; 06-27-2022: Robert Sewell		Created for IS-1 commissioning
...
;Increase THSL to 2.5% (THSL=2.5) and THFA to 12.8
...
echo STARTING commission_daxss_threshold_no_rx
echo This will change DAXSS X123 slow threshold to THSL=$setTHSL
echo and fast threshold to THFA=$setTHFA
...
while beacon_cmd_succ_count < $cmdCnt
	cmd_sd_playback stream UHF start $playbackOffset num 300 timeout 600 partition 2 decimation 1
	set cmdTry = cmdTry + 1
	wait 3500
endwhile

FINISH:
echo THSL Command sent for THSL=$setTHSL
