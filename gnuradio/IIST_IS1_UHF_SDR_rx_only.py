...
class IIST_IS1_UHF_SDR_rx_only(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "IIST_IS1_UHF_SDR_rx_only")
...
def main(top_block_cls=IIST_IS1_UHF_SDR_rx_only, options=None):
